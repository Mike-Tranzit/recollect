...
abstract class BasePayments extends GxActiveRecord {
	...
	public function rules() {
		return array(
			...
			array('amount_installation, amount_fee_license, zreport, repair', 'numerical', 'integerOnly'=>true),
			array('plate', 'length', 'max'=>25),
			array('comment', 'safe'),
			array('amount_installation, amount_fee_license, comment, zreport, repair', 'default', 'setOnEmpty' => true, 'value' => null),
			array('id, plate, amount_installation, amount_fee_license, date, comment, zreport, repair', 'safe', 'on'=>'search'),
		);
	}
